...
const About = () => {
    return (
        <div style={{ textAlign: "center"}}>
            <h3>Version 1.0.0</h3>
                <br/>
            <h4>This is an app made in React to illustrate some of its concepts, like
                It is linked to a server made with NodeJS, the database is in JSON and it's able to perform CRUD operations.
            </h4>
            <p>
